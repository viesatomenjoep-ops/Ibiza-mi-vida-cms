...
CREATE TABLE IF NOT EXISTS featured_events (
  ...
  category     TEXT NOT NULL CHECK (category IN (
                 'club-ticket','boat-party','private-boat','drink-package',
                 'guestlist','vip-catamaran','formentera-boat','aftersun',
...
ALTER TABLE featured_events ADD COLUMN IF NOT EXISTS comm_rate NUMERIC(5,2) DEFAULT 10;
...
-- Ensure image_url is optional
ALTER TABLE featured_events ALTER COLUMN image_url DROP NOT NULL;
